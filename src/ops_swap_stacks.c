...
/*   Updated: 2025/08/20 22:13:49 by valero           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	stack1_push_to_stack2(t_push_swap *push_swap, int push_a_to_b)
{
	...
	if (push_a_to_b)
	{
		...
		if (!transfer_succeeded)
			return (0);
		push_swap->stack_a->update_on_transfer(push_swap->stack_a, push_swap->stack_b);
		return (!!write(1, "pb\n", 3));
	}
	...
	if (!transfer_succeeded)
		return (0);
	push_swap->stack_b->update_on_transfer(push_swap->stack_b, push_swap->stack_a);
	return (!!write(1, "pa\n", 3));
}
